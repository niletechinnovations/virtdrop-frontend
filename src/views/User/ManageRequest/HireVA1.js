...
import industryBelongList from "./IndustryBelongList.json";
...
class HireVA1 extends Component {
  ...
  submitHandler(event) {
    ...
    this.setState({ loading: true }, () => {
      ...
      const arrayHashmap = selectedAreaNeed.map((e) =>
        e.vADesignation.map((elem) => {
          return {
      ...
      const formData = {
        howManyVas:
          this.state.needMore >= parseInt(this.state.selectedVaNumberByImage)
            ? this.state.needMore
            : parseInt(this.state.selectedVaNumberByImage),
      ...
      // return;
      commonService
        .postAPIWithAccessToken("hire/hire-va1", formData)
        .then((res) => {
          ...
          // this.props.history.push('/user/hire-va1');
        })
        .catch((err) => {
  ...
  skillFreelancers(event) {
    ...
    if (selectedTabValue[4].length > 0) {
      ...
      this.setState({
        ...
        disabledPageNew: disabledPageNew,
      });
    } else {
  ...
  timeChangeHandler(time) {
    ...
    var start_am_pm =
      splitedStatrtTime[0] >= 12 && splitedStatrtTime[1] >= 0 ? "PM" : "AM";
    ...
    var end_am_pm =
      splitedEndTime[0] >= 12 && splitedEndTime[1] >= 0 ? "PM" : "AM";
  ...
  SkillList() {
    this.setState({ loading: true }, () => {
      commonService
        .getAPIWithAccessToken("skill/get-new-skill")
        .then((res) => {
          console.log("RES=====iiii=Hire va=====>", res);
          if (undefined === res.data.data || !res.data.status) {
            this.setState({ loading: false });
            toast.error(res.data.message);
            return;
              ...
              <form onSubmit={(event) => this.submitHandler(event)} id="msform">
                ...
                >
                  ...
                  <TabList className="Client-form-nav-tabs ">
                    ...
                    <Tab disabled={disabledPageNew[1]} id="tabid-2" tabfor="1">
                      {" "}
                    </Tab>
                    <Tab
                      disabled={disabledPageNew[2]}
                      id="tabid-3"
                      tabfor="2"
                    ></Tab>
                    <Tab
                      disabled={disabledPageNew[3]}
                      id="tabid-4"
                      tabfor="3"
                    ></Tab>
                    <Tab
                      disabled={disabledPageNew[4]}
                      id="tabid-5"
                      tabfor="4"
                    ></Tab>
                    <Tab
                      disabled={disabledPageNew[5]}
                      id="tabid-6"
                      tabfor="5"
                    ></Tab>
                    <Tab
                      disabled={disabledPageNew[6]}
                      id="tabid-7"
                      tabfor="6"
                    ></Tab>
                    <Tab
                      disabled={disabledPageNew[7]}
                      id="tabid-8"
                      tabfor="7"
                    ></Tab>
                  </TabList>
                        ...
                        <div className="Client-form-step-content">
                          ...
                          <div className="Client-form-answer">
                            <div className="form-radio-group">
                              <h4 className="heading-title-sm">
                                How many VA do you need?
                              </h4>
                                ...
                                <li style={{ width: "19%" }}>
                                  <div className="SRcheckbox">
                                    <input
                                      ...
                                      id="1"
                                      checked={
                                        selectedTabValue[1].indexOf("1") >= 0
                                          ? true
                                          : false
                                      }
                                      type="checkbox"
                                      value="1"
                                      onChange={this.addManyVaHnadler}
                                    />
                                    <label htmlFor="1">
                                      <img
                                        src="/images/one-person.svg"
                                        height="60"
                                      />
                                      <span className="SRRadio-value-text">
                                        1
                                      </span>
                                    </label>
                                  </div>
                                ...
                                <li style={{ width: "19%" }}>
                                  <div className="SRcheckbox">
                                    <input
                                      ...
                                      id="two-person"
                                      checked={
                                        selectedTabValue[1].indexOf("2") >= 0
                                          ? true
                                          : false
                                      }
                                      type="checkbox"
                                ...
                                <li style={{ width: "19%" }}>
                                  <div className="SRcheckbox">
                                    <input
                                      ...
                                      id="three-person"
                                      checked={
                                        selectedTabValue[1].indexOf("3") >= 0
                                          ? true
                                          : false
                                      }
                                      type="checkbox"
                                ...
                                <li style={{ width: "19%" }}>
                                  <div className="SRcheckbox">
                                    <input
                                      ...
                                      id="four-person"
                                      checked={
                                        selectedTabValue[1].indexOf("4") >= 0
                                          ? true
                                          : false
                                      }
                                      type="checkbox"
                                ...
                                <li style={{ width: "19%" }}>
                                  <div className="SRcheckbox">
                                    <input
                                      ...
                                      id="five-person"
                                      checked={
                                        selectedTabValue[1].indexOf("5") >= 0
                                          ? true
                                          : false
                                      }
                                      type="checkbox"
                                ...
                                <li style={{ width: "19%" }}>
                                  <div className="SRcheckbox">
                                    <input
                                      ...
                                      id="six-person"
                                      checked={
                                        selectedTabValue[1].indexOf("6") >= 0
                                          ? true
                                          : false
                                      }
                                      type="checkbox"
                                ...
                                <li style={{ width: "19%" }}>
                                  <div className="SRcheckbox">
                                    <input
                                      ...
                                      id="seven-person"
                                      checked={
                                        selectedTabValue[1].indexOf("7") >= 0
                                          ? true
                                          : false
                                      }
                                      type="checkbox"
                                ...
                                <li style={{ width: "19%" }}>
                                  <div className="SRcheckbox">
                                    <input
                                      ...
                                      id="eight-person"
                                      checked={
                                        selectedTabValue[1].indexOf("8") >= 0
                                          ? true
                                          : false
                                      }
                                      type="checkbox"
                                ...
                                <li style={{ width: "19%" }}>
                                  <div className="SRcheckbox">
                                    <input
                                      ...
                                      id="nine-person"
                                      checked={
                                        selectedTabValue[1].indexOf("9") >= 0
                                          ? true
                                          : false
                                      }
                                      type="checkbox"
                                ...
                                <li style={{ width: "19%" }}>
                                  <div className="SRcheckbox">
                                    <input
                                      ...
                                      id="ten-person"
                                      checked={
                                        selectedTabValue[1].indexOf("10") >= 0
                                          ? true
                                          : false
                                      }
                                      type="checkbox"
                                ...
                                <li>
                                  <label htmlFor="1">
                                    <input
                                      ...
                                      name="1"
                                      checked={
                                        selectedTabValue[2].indexOf("1") >= 0
                                          ? true
                                          : false
                                      }
                                      onChange={this.industryBelongHandler}
                                    />
                                    <div className="ar-field-list-option-1">
                                      <div className="field-svg-icon">
                                        <a href="#">
                                          <img
                                            src="/images/advertisingi.svg"
                                            height="60"
                                            alt="Advertising"
                                          />
                                        </a>
                                ...
                                <li>
                                  <label htmlFor="2">
                                    <input
                                      ...
                                      name="2"
                                      checked={
                                        selectedTabValue[2].indexOf("2") >= 0
                                          ? true
                                          : false
                                      }
                                      onChange={this.industryBelongHandler}
                                    ...
                                    <div className="ar-field-list-option-1">
                                      <div className="field-svg-icon">
                                        <a href="#">
                                          <img
                                            src="/images/accounting_finance.svg"
                                ...
                                <li>
                                  <label htmlFor="3">
                                    <input
                                      ...
                                      name="3"
                                      checked={
                                        selectedTabValue[2].indexOf("3") >= 0
                                          ? true
                                          : false
                                      }
                                      onChange={this.industryBelongHandler}
                                ...
                                <li>
                                  <label htmlFor="4">
                                    <input
                                      ...
                                      name="4"
                                      checked={
                                        selectedTabValue[2].indexOf("4") >= 0
                                          ? true
                                          : false
                                      }
                                      onChange={this.industryBelongHandler}
                                    ...
                                    <div className="ar-field-list-option-1">
                                      <div className="field-svg-icon">
                                        <a href="#">
                                          <img
                                            src="/images/constructionArchEng.svg"
                                            height="60"
                                          />
                                        </a>
                                      </div>
                                ...
                                <li>
                                  <label htmlFor="5">
                                    <input
                                      ...
                                      name="5"
                                      checked={
                                        selectedTabValue[2].indexOf("5") >= 0
                                          ? true
                                          : false
                                      }
                                      onChange={this.industryBelongHandler}
                                ...
                                <li>
                                  <label htmlFor="6">
                                    <input
                                      ...
                                      name="6"
                                      checked={
                                        selectedTabValue[2].indexOf("6") >= 0
                                          ? true
                                          : false
                                      }
                                      onChange={this.industryBelongHandler}
                                ...
                                <li>
                                  <label htmlFor="7">
                                    <input
                                      ...
                                      name="7"
                                      checked={
                                        selectedTabValue[2].indexOf("7") >= 0
                                          ? true
                                          : false
                                      }
                                      onChange={this.industryBelongHandler}
                                ...
                                <li>
                                  <label htmlFor="8">
                                    <input
                                      ...
                                      name="8"
                                      checked={
                                        selectedTabValue[2].indexOf("8") >= 0
                                          ? true
                                          : false
                                      }
                                      onChange={this.industryBelongHandler}
                                ...
                                <li>
                                  <label htmlFor="9">
                                    <input
                                      ...
                                      name="9"
                                      checked={
                                        selectedTabValue[2].indexOf("9") >= 0
                                          ? true
                                          : false
                                      }
                                      onChange={this.industryBelongHandler}
                                ...
                                <li>
                                  <label htmlFor="10">
                                    <input
                                      ...
                                      name="10"
                                      checked={
                                        selectedTabValue[2].indexOf("10") >= 0
                                          ? true
                                          : false
                                      }
                                      onChange={this.industryBelongHandler}
                                ...
                                <li>
                                  <label htmlFor="0">
                                    <input
                                      ...
                                      id="0"
                                      checked={
                                        selectedTabValue[3].indexOf("1") >= 0
                                          ? true
                                          : false
                                      }
                                      value="0"
                                      name="0"
                                      onChange={this.clientAreaNeedHandler}
                                    />
                                    <div className="ar-field-list-option-1">
                                      <div className="field-svg-icon">
                                        <a href="#">
                                          <img
                                            src="/images/adminstrative.svg"
                                            height="60"
                                          />{" "}
                                        </a>
                                      </div>
                                ...
                                <li>
                                  <label htmlFor="1">
                                    <input
                                      ...
                                      id="1"
                                      checked={
                                        selectedTabValue[3].indexOf("9") >= 0
                                          ? true
                                          : false
                                      }
                                      value="1"
                                ...
                                <li>
                                  <label htmlFor="2">
                                    <input
                                      ...
                                      id="2"
                                      checked={
                                        selectedTabValue[3].indexOf("15") >= 0
                                          ? true
                                          : false
                                      }
                                      value="2"
                                    ...
                                    <div className="ar-field-list-option-1">
                                      <div className="field-svg-icon">
                                        <a href="#">
                                          <img
                                            src="/images/ecommarce_related_task.svg"
                                            height="60"
                                          />{" "}
                                        </a>
                                      </div>
                                ...
                                <li>
                                  <label htmlFor="3">
                                    <input
                                      ...
                                      id="3"
                                      checked={
                                        selectedTabValue[3].indexOf("25") >= 0
                                          ? true
                                          : false
                                      }
                                      value="3"
                                ...
                                <li>
                                  <label htmlFor="4">
                                    <input
                                      ...
                                      id="4"
                                      checked={
                                        selectedTabValue[3].indexOf("31") >= 0
                                          ? true
                                          : false
                                      }
                                      value="4"
                                ...
                                <li>
                                  <label htmlFor="5">
                                    <input
                                      ...
                                      id="5"
                                      checked={
                                        selectedTabValue[3].indexOf("40") >= 0
                                          ? true
                                          : false
                                      }
                                      value="5"
                                ...
                                <li>
                                  <label htmlFor="6">
                                    <input
                                      ...
                                      id="6"
                                      checked={
                                        selectedTabValue[3].indexOf("47") >= 0
                                          ? true
                                          : false
                                      }
                                      value="6"
                                    ...
                                    <div className="ar-field-list-option-1">
                                      <div className="field-svg-icon">
                                        <a href="#">
                                          <img
                                            src="/images/icons/accounting_BookKeeping.svg"
                                            height="60"
                                          />{" "}
                                        </a>
                                      </div>
                                ...
                                <li>
                                  <label htmlFor="7">
                                    <input
                                      ...
                                      id="7"
                                      checked={
                                        selectedTabValue[3].indexOf("53") >= 0
                                          ? true
                                          : false
                                      }
                                      value="7"
                                    ...
                                    <div className="ar-field-list-option-1">
                                      <div className="field-svg-icon">
                                        <a href="#">
                                          <img
                                            src="/images/icons/cold_calling.svg"
                                            height="60"
                                          />{" "}
                                        </a>
                                      </div>
                                ...
                                <li>
                                  <label htmlFor="8">
                                    <input
                                      ...
                                      id="8"
                                      checked={
                                        selectedTabValue[3].indexOf("59") >= 0
                                          ? true
                                          : false
                                      }
                                      value="8"
                                    ...
                                    <div className="ar-field-list-option-1">
                                      <div className="field-svg-icon">
                                        <a href="#">
                                          <img
                                            src="/images/icons/programming_development.svg"
                                            height="60"
                                          />
                                        </a>
                                      </div>
                              ...
                              <div className="filter-Category-list">
                                {selectedArea.map((e, index) => {
                                  return (
                                    <div
                                      key={index}
                                      className="filter-Category-item-info"
                                    >
                                      <h2>{e.parentName}</h2>
                                              ...
                                              <li key={va.id}>
                                                <div className="filterCheckbox">
                                                  <input
                                                    ...
                                                    value={va.id}
                                                    onChange={
                                                      this.skillFreelancers
                                                    }
                                                    checked={
                                                      selectedTabValue[4].indexOf(
                                                        va.id
                                                      ) >= 0
                                                        ? true
                                                        : false
                                ...
                                <li>
                                  <div className="checkbox-box1">
                                    <input
                                      ...
                                      id="Sun"
                                      checked={
                                        selectedTabValue[5].indexOf("Sunday") >=
                                        0
                                          ? true
                                          : false
                                      }
                                      onChange={this.dayHnadler}
                                    />
                                ...
                                <li>
                                  <div className="checkbox-box1">
                                    <input
                                      ...
                                      id="Mon"
                                      checked={
                                        selectedTabValue[5].indexOf("Monday") >=
                                        0
                                          ? true
                                          : false
                                      }
                                ...
                                <li>
                                  <div className="checkbox-box1">
                                    <input
                                      ...
                                      id="Fri"
                                      checked={
                                        selectedTabValue[5].indexOf("Friday") >=
                                        0
                                          ? true
                                          : false
                                      }
                                ...
                                <div data-role="page">
                                  <div data-role="main" className="ui-content">
                                    ...
                                    <FormGroup>
                                      ...
                                      <Label>
                                        Start Time: {this.state.timer.start}{" "}
                                        {this.state.start_am_pm}
                                      </Label>
                                      <Label style={{ marginLeft: "10px" }}>
                                        End Time :{this.state.timer.end}{" "}
                                        {this.state.end_am_pm}{" "}
                                      </Label>
                                      <TimeRangeSlider
                                        disabled={false}
                                        format={24}
                                  ...
                                  <div className="col-xs-12 col-md-4">
                                    <div className="panel panel-primary">
                                      <div className="panel-heading">
                                        <h5 className="panel-title p-0 mt-2">
                                          Standard
                                        </h5>
                                      </div>
                              ...
                              <ul className="filter-Category-nav-list">
                                <li>
                                  <div className="SRRadio">
                                    <input
                                      name="question1[]"
                                      id="question6[Within 48 hours]"
                                      type="radio"
                                      value="1"
                                      checked={
                                        selectedTabValue[7].indexOf("1") >= 0
                                          ? true
                                          : false
                                      }
                                      onChange={this.needSomeoneQuickly}
                                    />
                                    <label htmlFor="question6[Within 48 hours]">
                                      Within 48 hours
                                    </label>
                                  </div>
                                </li>
                                <li>
                                  <div className="SRRadio">
                                    <input
                                      name="question1[]"
                                      id="question6[No Rush, wait best candidate]"
                                      type="radio"
                                      value="2"
                                      checked={
                                        selectedTabValue[7].indexOf("2") >= 0
                                          ? true
                                          : false
                                      }
                                      onChange={this.needSomeoneQuickly}
                                    />
                                    <label htmlFor="question6[No Rush, wait best candidate]">
                                      Under No Rush, wait for best candidate
                                    </label>
                                  </div>
                                </li>
                              </ul>
                                ...
                                <div className="col-md-6 form-info">
                                  <div className="form-group">
                                    ...
                                    <input
                                      ...
                                      value={somthingAboutYou.firstPersonName}
                                      className="form-control"
                                      placeholder="Enter  First Name Of the Person"
                                      onChange={this.somthingAboutYouHandler}
                                      required
                                    />
                                  </div>
                                </div>
                                <div className="col-md-6 form-info">
                                  <div className="form-group">
                                    ...
                                    <input
                                      type="text"
                                      name="lastPersonName"
                                      value={somthingAboutYou.lastPersonName}
                                      className="form-control"
                                      placeholder="Enter  Last Name Of the Person"
                                      onChange={this.somthingAboutYouHandler}
                                      required
                                    />
                                  </div>
                                ...
                                <div className="col-md-6 form-info">
                                  <div className="form-group">
                                    ...
                                    <input
                                      type="text"
                                      name="companyName"
                                      value={somthingAboutYou.companyName}
                                      onChange={this.somthingAboutYouHandler}
                                      className="form-control"
                                ...
                                <div className="col-md-6 form-info">
                                  <div className="form-group">
                                    ...
                                    <input
                                      type="text"
                                      name="companyAddress"
                                      value={somthingAboutYou.companyAddress}
                                      onChange={this.somthingAboutYouHandler}
                                      className="form-control"
                                ...
                                <div className="col-md-6 form-info">
                                  <div className="form-group">
                                    ...
                                    <input
                                      type="text"
                                      name="phoneNumber"
                                      value={somthingAboutYou.phoneNumber}
                                      onChange={this.somthingAboutYouHandler}
                                      className="form-control"
