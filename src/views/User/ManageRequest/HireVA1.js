...
class HireVA1 extends Component {
    ...
    submitHandler(event) {
        ...
        this.setState({ loading: true }, () => {
            ...
            const formData = {
                ...
                HowManyVas: this.state.needMore > 0 ? this.state.needMore : this.state.selectedVaNumberByImage,
    ...
    render() {
        const { loading, selectedArea, clientArea, item, tabIndex, Administrative, industryBelong, addVa, active, selectedTabValue, somthingAboutYou, selectedTab, tabCount, indexChange, needMore, industryBelongList, disabledPage, disabledPageNew } = this.state;
        ...
        console.log("disabledPage-------------", disabledPage)
                                                        ...
                                                        <div className="row">
                                                            <div className="col-md-12 form-info">
                                                                <div className="form-group">
                                                                    ...
                                                                    <input type="text" name="fname" className="form-control" placeholder="Type" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="Client-form-answer">
                                                    <div className="form-radio-group">
                                                        <ul className="filter-field-list text-left">
                                                            ...
                                                            <li>
                                                                <label htmlFor="8">
                                                                    <input type="checkbox" id="8" checked={selectedTabValue[3].indexOf("58") >= 0 ? true : false} value="8" name="8" onChange={this.clientAreaNeedHandler} />
                                                                    <div className="ar-field-list-option-1">
                                                                        <div className="field-svg-icon">
                                                ...
                                                <div className="Client-form-answer">
                                                    <div className="form-input-group">
                                                        <ul className="filter-Category-nav-list">
                                                            ...
                                                            <li>
                                                                <div className="SRRadio">
                                                                    <input name="question1[]" id="question6[No Rush, wait htmlFor best candidate]" type="radio"
                                                                        value="2" checked={selectedTabValue[7].indexOf("2") >= 0 ? true : false} onChange={this.needSomeoneQuickly} />
                                                                    <label htmlFor="question6[No Rush, wait htmlFor best candidate]">Under No Rush, wait htmlFor best candidate</label>
                                                                </div>
                                                            </li>
                                                        </ul>
                                                    </div>
