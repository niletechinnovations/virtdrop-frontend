...
import BillingData from './VaPayoutData';


class VaPayoutList extends Component {
  constructor(props){
    super(props);
    this.state = {
      modal: false,
      ...
      rowIndex: -1,
      formField: { invoiceId: '', transactionId:'', vaName: '', notes: '', billingHours:'', billingDate:'', status:'' },
  ...
  /*VA Request List API*/
  itemList(filterItem = {}) {
    let filterQuery = "?pageSize=10000&billingFor=va";
          ...
          <Form onSubmit={this.submitHandler} noValidate>
            <ModalBody>
              ...
              <Row>
                <Col md={"6"}>
                  <FormGroup> 
                    <Label><strong>Client:</strong> {formField.vaName}</Label>            
                  </FormGroup> 
                </Col>
                <Col md={"6"}>
                  <FormGroup> 
