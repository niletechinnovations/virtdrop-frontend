...
class AddVaApplication extends Component {
  ...
  componentDidMount() {
    ...
    // this.SkillListData();
    // console.log("ClientAreaNeed", ClientAreaNeed.clientArea.map(e => {
    //   return (e.vADesignation.map(va =>
  ...
  submitFormData(e) {
    ...
    if (this.validateForm()) {
      ...
      // console.log("this.state.childSelectedItem",this.state.childSelectedItem, "-------2-------",this.state.childSelectedItem1,"--------3-----", this.state.childSelectedItem2)
