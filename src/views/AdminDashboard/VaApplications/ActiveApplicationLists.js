...
class ActiveApplicationLists extends Component {
  constructor(props){
    super(props);
    this.state = {
      itemList: [],
  ...
  itemList(filterItem = {}) {
    let filterQuery = "?pageSize=10000&status=2";
          ...
          <Col lg={12}>
            <Card>
              <CardHeader className="mainHeading">
                <strong>Active VA Application List</strong>
...
export default ActiveApplicationLists;
