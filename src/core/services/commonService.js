...
// const API_BASE_URL = 'https://virtdrop-api.herokuapp.com/';     //'https://www.virtdrop.com/api/';   //'http://localhost:8082/';
// const API_BASE_URL = "http://localhost:8082/"; 
    //  const API_BASE_URL ="https://virtdrop.herokuapp.com/hireva/";
// const API_BASE_URL = "https://virtdrop-api.herokuapp.com/";
export const API_BASE_URL = 'https://api.virtdrop.com/api/';
const API_BASE_URL_WITH_OUT_VERSION = "https://api.virtdrop.com/api/";
class ApiService {
  /*Get API*/
  getAPI(urlSegment) {
  ...
  deleteAPIWithAccessToken(urlSegment, formdata = {}) {
    ...
    //debugger;
    return axios.delete(API_BASE_URL + urlSegment, {
      headers: headers,
      data: formdata,
    });
  }
